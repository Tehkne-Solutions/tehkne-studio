...
if (!["S2.16", "S2.17", "S2.18", "S2.19"].some((marker) => workbench.includes(marker))) throw new Error("S2.16 workbench lineage marker missing");
...
console.log("S2.16 Mechanical Assembly Constraints PASS · S2.15 Direct Socket Wiring preserved through S2.19 + connectedTo-derived coincident constraints + AF-001 v0.6.6 canonical physical sockets/proxy anchors + AF-001M fail-closed promotion evidence + atomic assembly movement + no parallel graph · Tehkné Solutions");