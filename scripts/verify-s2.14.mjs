...
if (!workbench.includes("Direct Socket Wiring") && !workbench.includes("Mechanical Assembly")) throw new Error("S2.14 semantic presentation lineage missing");
...
console.log("S2.14 Socket-Aware Wiring PASS · semantic socket-aware contract + graph port identity + AF-001 v0.6.6 physical endpoint projection · Tehkné Solutions");