...
if (!["S2.14", "S2.15", "S2.16"].some((marker) => workbench.includes(marker))) throw new Error("S2.14 workbench lineage marker missing");
...
console.log("S2.14 Socket-Aware Wiring PASS · graph port identity + AF-001 v0.6.6 physical socket transforms + successor endpoint projection preserves direct wiring and assembly · Tehkné Solutions");
