...
if (!["S2.13", "S2.14", "S2.15", "S2.16", "S2.17", "S2.18", "S2.19"].some((marker) => workbench.includes(marker))) throw new Error("S2.13 workbench lineage marker missing");
...
console.log("S2.13 Asset-Backed Invention Rendering PASS · AF-001 v0.6.6 physical-socket candidate + explicit proxy fallback + same Engineering Graph/spatial persistence + HERO_CANDIDATE preserved through S2.19 · Tehkné Solutions");