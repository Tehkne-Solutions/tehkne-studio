...
export function SpatialWorkbench() {
        ...
        : product === "smartphone"
          ...
          : product === "notebook"
            ...
            : product === "tablet"
              ...
              : product === "tv"
                ? "TV 01 pronta. Abra o gabinete, inspecione fonte/painel/HDMI, remova a fonte ou teste o boot causal."
  ...
  const runUtterance = async (utterance: string, source: "ui" | "voice") => {
    ...
    const looksTv = /\b(tv|televisao|televisão|televisor|smart tv)\b/i.test(trimmed);
              ...
              : activeProduct === "smartphone"
                ...
                : activeProduct === "notebook"
                  ...
                  : activeProduct === "tablet"
                    ...
                    : activeProduct === "tv"
                      ? "Ex.: abra a TV · inspecione a fonte · tire a fonte · ligue · por que não iniciou?"
